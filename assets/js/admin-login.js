...
async function initLoginPage() {
  ...
  if (typeof AuthManager === 'undefined') {
    console.warn('AuthManager not yet available, skipping auth check');
    setupLoginForm();
    return;
  }
...
function setupLoginForm() {
  ...
  async function handleLogin() {
    ...
    try {
      ...
      localStorage.setItem("last_admin_username", username);
      ...
      let errorMessage = "Login gagal. Periksa username dan password Anda.";
...
function addLoginHelpers() {
  ...
  // Username will be saved directly in the login success handler
...
// Add connection status check before login attempts
function checkConnectionStatus() {
  if (!navigator.onLine) {
    Utils.showAlert("Tidak ada koneksi internet. Periksa koneksi Anda.", "error");
    return false;
  }
  return true;
}
